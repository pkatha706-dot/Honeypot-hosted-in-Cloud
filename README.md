...
11. T-Pot Web Interface Access
   Screenshot: Browser showing T-Pot login page at VM_IP:64297
...
13. Elasticvue Server Monitoring
   Screenshot: Elasticvue dashboard showing cluster health and statistics
...
11. Kibana Dashboard Analysis
   Screenshot: Kibana dashboard showing attack statistics by honeypot type
...
11. CVE Exploit Tracking
    Screenshot: Dashboard showing CVE details of attempted exploits
...
12. Spiderfoot OSINT Investigation
    Screenshot: Spiderfoot results showing attacker IP analysis
